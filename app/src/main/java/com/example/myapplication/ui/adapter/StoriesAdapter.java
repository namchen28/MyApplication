...
public class StoriesAdapter extends RecyclerView.Adapter<StoriesAdapter.ViewHodler>
{
    ...
    @NonNull
    @Override
    public StoriesAdapter.ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull StoriesAdapter.ViewHodler holder, int position) {
