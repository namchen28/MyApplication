...
public class CategoryQuizAdapter extends RecyclerView.Adapter<CategoryQuizAdapter.ViewHodler>
{
    ...
    @NonNull
    @Override
    public CategoryQuizAdapter.ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CategoryQuizAdapter.ViewHodler holder, int position) {
